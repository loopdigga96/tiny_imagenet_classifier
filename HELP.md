...
|:--------------- |:----------- |:----------- |:-------------------------- | 
| `data/` | Data | `storage:test-task/data/` | `/test-task/data/` | 
| `modules/` | Python modules | `storage:test-task/modules/` | `/test-task/modules/` |
| `config/` | Configuration files | `storage:test-task/config/` | `/test-task/config/` |
| `notebooks/` | Jupyter notebooks | `storage:test-task/notebooks/` | `/test-task/notebooks/` |
| `results/` | Logs and results | `storage:test-task/results/` | `/test-task/results/` |
...
into `storage:test-task/data` mounted to your development environment's `/project/data`.
